...
public class AuthController {
    ...
    private static final String CLIENT_ID = "1075462838223-6r7k8rfofknaqert59tft0n2doirm1m1.apps.googleusercontent.com"; // Replace with your own CLIENT_ID
     ...
     * @param googleAuthService Google authentication service.
     */
    @Autowired
    ...
    /**
     * Controller for authenticating with Google.
     * @param googleAuthDTO The GoogleAuthDTO object containing the Google ID token.
     * @return A ResponseEntity object containing the Google authentication DTO.
     * @throws ResponseStatusException If authentication fails or the user is not authorized.
     */
